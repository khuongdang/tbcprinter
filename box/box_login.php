...
<table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center" class="font_xam">						
						...
						<br/>
						<span style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FF0000">
							<b><?=$l_LoginSuccess?></b>						</span>
						<br/>
				  </td>
				</tr>
				<tr>
				  <td height="30" align="center" class="font_xam">[ <a class="aMagenta" href="./?frame=logout"><?=$l_btnLogout?></a> ]</td>
  </tr>
</table>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
	  ...
	  <tr>
          <td class="font_xam">Username : 
            <input name="txtUid" type="text" class="font_xam" onFocus="this.value='';"  value="Tên đăng nhập..."  size="20"/>	    </td>
      </tr>		
	  <tr>
		<td class="font_xam">Password : 
	    <input name="txtPwd" type="password" class="font_xam" onFocus="this.value='';" value="password" /></td>
	  </tr>
	  <tr>
	    <td align="left" class="font_xam"><a href="./?frame=registry" class="link_menu_sp">Đăng ký </a></td>
	    </tr>
	  <tr>
	    <td align="left" class="font_xam"><a href="./?frame=forgotpass" class="link_menu_sp">Quên mật khẩu </a></td>
	    </tr>
	  <tr>
		<td height="25" align="center" valign="middle">
			<input class="buttonorange" onmouseover="this.className='bg_over'" style="WIDTH: 89px; HEIGHT: 22px; cursor:pointer" onmouseout="this.className='bg_out'" type="submit" value="<?=$l_btnLogin?>" name="btnLogin" onclick="return btnLogin_onclick();"/>		</td>
		</tr>
	  </form>
</table> 
