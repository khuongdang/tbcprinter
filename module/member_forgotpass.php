				...
				<tr>
					<td valign="top">
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
							<tr><td height="10" colspan="3" class="font_xam"></td>
							</tr>
							<tr>
								<td colspan="3" class="font_xam">
								<p align="justify">
								<?
								echo $_lang == 'vn' ? 'Hãy điền đầy đủ thông tin và gởi về cho chúng tôi, bạn sẽ nhận lại mật khẩu theo địa chỉ hộp thư.' : 'Please send your infomation, we\'ll send your password to your e-mail address !'?>
								</p>
							  </td>
							</tr>
							<tr><td height="10" colspan="3" class="font_xam"></td>
							...
							<tr>
								...
								<td width="5" class="font_xam"><font color="#FF0000">*</font></td>
								<td class="font_xam">&nbsp;
							  <input name="txtUid" value="<?=$uid?>"></td>
							</tr>
							<tr>
								<td width="40%" align="right" class="font_xam"><?=$l_Email?>&nbsp;</td>
								<td width="5" class="font_xam"><font color="#FF0000">*</font></td>
								<td class="font_xam">&nbsp;
							  <input name="txtEmail" value="<?=$email?>"></td>
							</tr>
							<tr><td height="10" colspan="3" class="font_xam"></td>
							</tr>
							<tr>
								<td class="font_xam"></td>
								<td class="font_xam"></td>
							  <td class="font_xam">
