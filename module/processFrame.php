...
switch (addslashes($frame)) {
    ...
    case "products"            :
        ...
        break;
    case "product_new"        :
        include("module/product_new.php");
        break;
    case "product_detail"    :
    ...
    case "news_detail"      :
        ...
        break;
    case "download"         :
        include("module/baohanh_category.php");
        break;
    case "download_view"    :
        include("module/baohanh.php");
        break;
    case "download_detail"  :
        include("module/baohanh_detail.php");
        break;
    case "bottom"            :
    ...
    case "search"           :
        ...
        break;
    case "registry"         :
        include("module/member_registry.php");
        break;
    case "login"            :
        include("module/member_login.php");
        break;
    case "forgotpass"       :
        include("module/member_forgotpass.php");
        break;
    case "customer"         :
        include("module/customer.php");
        break;
    case "changepassword"   :
        include("module/member_changepassword.php");
        break;
    case "cart"                :
