...
<?
	for($j=0; $j<$col&&$products=mysql_fetch_assoc($result); $j++){
		$pro = getRecord("tbl_product","id=".$products['id'])?><td class="margin_bottom">
          ...
          <tr>
            <td height="35" align="center" valign="top" style="border-bottom:1px dashed #CCCCCC; padding-left:0px" ><a href="./?frame=cart&p=<?=$pro['id']?>"><div class="add_card" align="center" style="width:102px; height:22px; cursor:pointer" onMouseOver="this.className='add_card_hover'" onMouseOut="this.className='add_card'"></div></a></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
          </tr>
