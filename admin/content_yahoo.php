...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="190" class="title"><a class="title" href="<?=getLinkSort(2)?>">YM! ID</a></th>
		<th width="180" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên hiển thị</a></th>
		...
		<th width="102" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="102" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
