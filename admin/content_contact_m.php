	...
	<tr>
    	<td width="45%">
    		<table border="0" cellpadding="2" bordercolor="#111111" width="100%" cellspacing="0">
				...
				<tr>
					<td width="15%" class="smallfont" align="right">Liên hệ</td>
				...
				<tr><td height="10px"></td></tr>
			<!--	<tr>
					<td width="15%" class="smallfont" align="right">Thông tin liên hệ trực tuyến</td>
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont"><textarea name="txtDetail" cols="80" rows="10" id="txtDetail"><?=$detail?>
					</textarea></td>
				</tr>-->
				<tr><td height="10px"></td></tr>
				<tr>
					<td width="15%" class="smallfont" align="right">Nội dung bottom </td>
					<td width="1%" class="smallfont" align="center"></td>
