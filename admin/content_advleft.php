...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="149" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="50" class="title"><a class="title" href="<?=getLinkSort(8)?>">Hình</a></th>
		<th width="70" class="title"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="68" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="99" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
