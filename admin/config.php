...
if ($page!='') $p=$page;
$where = '1=1';
if (isset($_REQUEST['cat']) && $_REQUEST['cat']!='') $where='parent='.$_REQUEST['cat']?>
...
<? if (isset($_REQUEST['code']) && $_REQUEST['code']==1) $errMsg = 'Cập nhật thành công.'?>
...
if (isset($_REQUEST['sortby']) && $_REQUEST['sortby']!='') $sortby='order by '.(int)$_REQUEST['sortby'];

$direction=(isset($_REQUEST['direction']) && $_REQUEST['direction']=='' || isset($_REQUEST['direction']) && $_REQUEST['direction']=='0'?'desc':'');
