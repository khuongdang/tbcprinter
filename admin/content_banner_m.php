	...
	<tr>
       ...
       <tr>
        ...
        <tr>
          ...
          <td class="smallfont"><? if ($image!=''){ echo '<img border="0" src="../'.$image.'" width="500"><br><br>Hình ảnh';}?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="smallfont" align="right">Chọn hình </td>
          <td class="smallfont" align="center">&nbsp;</td>
          <td class="smallfont">	<input type="file" name="txtImage" class="textbox" size="34">
