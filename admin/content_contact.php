...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="140" class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên</a></th>
		<th width="117" align="center" class="title"><a class="title" href="<?=getLinkSort(5)?>">Liên hệ </a></th>
		<th width="117" align="center" class="title"><a class="title" href="<?=getLinkSort(7)?>">Hỗ trợ liên hệ </a></th>		
		<th width="145" class="title"><a class="title" href="<?=getLinkSort(6)?>">Nội dung</a></th>		
		<th width="116" class="title"><a class="title" href="<?=getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="140" class="title"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="133" class="title"><a class="title" href="<?=getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
