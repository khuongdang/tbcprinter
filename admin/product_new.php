...
<table border="1" cellpadding="2" style="border-collapse: collapse" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(4)?>">Thiết bị</a></th>
		<th width="100" class="title"><a class="title" href="<?=getLinkSort(4)?>">Máy bộ</a></th>
...
while($row=mysql_fetch_array($result)){
	...
	<tr>
		...
		<td width="30" align="center" bgcolor="<?=$color?>" class="smallfont">
			...
			>Xóa</a>		</td>
		<td bgcolor="<?=$color?>" class="smallfont"><a href="./?act=<?=$actConfig?>_m&id=<?=$row['id']?>&page=<?=$page?>"><?=$pro['name']?></a></td>
